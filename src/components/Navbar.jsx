...
function Navbar() {
  ...
  return (
    <nav className="fixed w-full bg-white dark:bg-gray-800 shadow-md top-0 left-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">

        {/* Logo */}
        <h1 className="text-xl font-bold text-indigo-600 tracking-wide dark:text-gray-300">
          Seangleng Khe
        </h1>
