...
function TalkPage() {
  return (
    <>
      {/* HERO */}
      <section className="relative py-24 md:py-32 flex flex-col justify-center items-center bg-gradient-to-r from-indigo-600 via-blue-600 to-indigo-600 text-white text-center px-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {talks.map((t) => (
              <article
                key={t.title}
                className="group bg-gray-50 dark:bg-slate-800 rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition duration-300"
              >
                {t.image && (
